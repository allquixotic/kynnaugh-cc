...
void protobuf_AssignDesc_google_2fcloud_2fdataproc_2fv1_2foperations_2eproto() {
  ...
  ClusterOperationStatus_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      ClusterOperationStatus::default_instance_,
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ClusterOperationStatus, _is_default_instance_));
  ...
  ClusterOperationMetadata_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      ClusterOperationMetadata::default_instance_,
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ClusterOperationMetadata, _is_default_instance_));
}
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      ClusterOperationStatus_descriptor_, &ClusterOperationStatus::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      ClusterOperationMetadata_descriptor_, &ClusterOperationMetadata::default_instance());
}

}  // namespace

void protobuf_ShutdownFile_google_2fcloud_2fdataproc_2fv1_2foperations_2eproto() {
  delete ClusterOperationStatus::default_instance_;
  delete ClusterOperationStatus_reflection_;
  delete ClusterOperationMetadata::default_instance_;
  delete ClusterOperationMetadata_reflection_;
}

void protobuf_AddDesc_google_2fcloud_2fdataproc_2fv1_2foperations_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_google_2fcloud_2fdataproc_2fv1_2foperations_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\001(\t\022\023\n\013description\030\014 \001(\tB1\n\034com.google.c"
    "loud.dataproc.v1B\017OperationsProtoP\001b\006pro"
    "to3", 763);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "google/cloud/dataproc/v1/operations.proto", &protobuf_RegisterTypes);
  ClusterOperationStatus::default_instance_ = new ClusterOperationStatus();
  ClusterOperationMetadata::default_instance_ = new ClusterOperationMetadata();
  ClusterOperationStatus::default_instance_->InitAsDefaultInstance();
  ClusterOperationMetadata::default_instance_->InitAsDefaultInstance();
...
const ClusterOperationStatus& ClusterOperationStatus::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_google_2fcloud_2fdataproc_2fv1_2foperations_2eproto();
  return *default_instance_;
}

ClusterOperationStatus* ClusterOperationStatus::default_instance_ = NULL;
...
int ClusterOperationStatus::ByteSize() const {
...
void ClusterOperationMetadata::InitAsDefaultInstance() {
  _is_default_instance_ = true;
  status_ = const_cast< ::google::cloud::dataproc::v1::ClusterOperationStatus*>(&::google::cloud::dataproc::v1::ClusterOperationStatus::default_instance());
}
...
ClusterOperationMetadata* ClusterOperationMetadata::default_instance_ = NULL;
...
int ClusterOperationMetadata::ByteSize() const {
