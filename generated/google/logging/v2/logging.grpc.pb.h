...
class LoggingServiceV2 final {
 public:
  ...
  typedef WithStreamedUnaryMethod_DeleteLog<WithStreamedUnaryMethod_WriteLogEntries<WithStreamedUnaryMethod_ListLogEntries<WithStreamedUnaryMethod_ListMonitoredResourceDescriptors<Service > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_DeleteLog<WithStreamedUnaryMethod_WriteLogEntries<WithStreamedUnaryMethod_ListLogEntries<WithStreamedUnaryMethod_ListMonitoredResourceDescriptors<Service > > > > StreamedService;
};
